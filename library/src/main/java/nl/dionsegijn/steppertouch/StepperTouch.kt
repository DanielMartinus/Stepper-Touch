...
class StepperTouch : FrameLayout, OnStepCallback {
    ...
    private val defaultHeight: Int = pxFromDp(40f)
            .toInt()
    ...
    // Style properties
    private var stepperBackground = R
            .color
            .stepper_background
    private var stepperActionColor = R
            .color
            .stepper_actions
    private var stepperActionColorDisabled = R
            .color
            .stepper_actions_disabled
    private var stepperTextColor = R
            .color
            .stepper_text
    private var stepperButtonColor = R
            .color
            .stepper_button
    private var stepperTextSize = 20
    private var stepperMaxCount = Integer
            .MAX_VALUE
    ...
    private fun handleAttrs(attrs: AttributeSet) {
        val styles: TypedArray = context
                .theme
                .obtainStyledAttributes(attrs, R.styleable.StepperTouch, 0, 0)

        try {
            stepperBackground = styles
                    .getResourceId(R.styleable.StepperTouch_stepperBackgroundColor, R.color.stepper_background)
            stepperActionColor = styles
                    .getResourceId(R.styleable.StepperTouch_stepperActionsColor, R.color.stepper_actions)
            stepperActionColorDisabled = styles
                    .getResourceId(R.styleable.StepperTouch_stepperActionsDisabledColor, R.color.stepper_actions_disabled)
            stepperTextColor = styles
                    .getResourceId(R.styleable.StepperTouch_stepperTextColor, R.color.stepper_text)
            stepperButtonColor = styles
                    .getResourceId(R.styleable.StepperTouch_stepperButtonColor, R.color.stepper_button)
            stepperTextSize = styles
                    .getDimensionPixelSize(R.styleable.StepperTouch_stepperTextSize, R.dimen.st_textsize)
            stepperMaxCount = styles
                    .getInt(R.styleable.StepperTouch_stepperMaxCount, Integer.MAX_VALUE)
            stepperMinCount = styles
                    .getInt(R.styleable.StepperTouch_stepperMinCount, Integer.MIN_VALUE)
            stepperCount = styles
    ...
    private fun prepareElements() {
        ...
        this
                .background = parentRadius
        parentRadius
                .setColor(ContextCompat.getColor(context, stepperBackground))
        ...
        // update grayed out button style
        onStep(viewStepper.getValue(), true)
        addView(viewStepper)
    }
    ...
    private fun createStepper(): StepperCounter {
        ...
        setStepperSize(view)
        view
                .setMax(stepperMaxCount)
        view
                .setMin(stepperMinCount)
        view
                .setValue(stepperCount.coerceIn(stepperMinCount, stepperMaxCount))
    ...
    private fun setStepperSize(view: StepperCounter) {
        view
                ...
                .LayoutParams(newHeight, newHeight, Gravity.CENTER)
        val stepperRadius = getRadiusBackgroundShape(newHeight.toFloat())
        stepperRadius
                .setColor(ContextCompat.getColor(context, stepperButtonColor))
        view
                .background = stepperRadius
    }

    override fun onStep(value: Int, positive: Boolean) {
        textViewNegative
                .setTextColor(ContextCompat.getColor(context, if (value == viewStepper.minValue) stepperActionColorDisabled else stepperActionColor))
        textViewPositive
                .setTextColor(ContextCompat.getColor(context, if (value == viewStepper.maxValue) stepperActionColorDisabled else stepperActionColor))
    }
    ...
    private fun createTextView(text: String, gravity: Int, @ColorRes color: Int): TextView {
        ...
        val paramsTextView = FrameLayout
                .LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, gravity)
        textView
                .layoutParams = paramsTextView
        textView
                .gravity = Gravity
                .CENTER_VERTICAL
        val margin = pxFromDp(12f)
                .toInt()
        textView
    ...
    override fun onDraw(canvas: Canvas) {
        rect
                .let { rect = RectF(canvas.clipBounds) }
